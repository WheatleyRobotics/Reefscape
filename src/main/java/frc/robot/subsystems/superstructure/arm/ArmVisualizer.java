...
import static frc.robot.subsystems.superstructure.arm.ArmConstants.armLength;
import static frc.robot.subsystems.superstructure.arm.ArmConstants.armOrigin;
...
public class ArmVisualizer {
  ...
  public ArmVisualizer(String key, Color color) {
    ...
    arm = new LoggedMechanismLigament2d("arm", armLength, 20.0, 6, new Color8Bit(color));
    root.append(arm);
  }
